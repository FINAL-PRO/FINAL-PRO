					...
					<div class="dc-content">
						...
						<div class="dc-content-box">
							<div class="board_area">
								<form name="boardFrm"
									action="${pageContext.request.contextPath}/community/food/foodUpdateFormEnd.do?no=${board.no}"
									method="post">
									<div>
									...
									<script>
										$("#btn_board_save").click(function() {
												boardFrm.action = "${pageContext.request.contextPath}/community/food/foodUpdateFormEnd.do?no=${board.no}"
												boardFrm.submit();
											});
