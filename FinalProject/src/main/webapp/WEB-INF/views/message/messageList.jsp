...
<body>
	...
	<div class="nav">&nbsp;&nbsp;
		<c:if test="${param.no != null}">
			<a class="navList" style="font-weight: bold" href="${pageContext.request.contextPath}/message/list.do?no=${member.no}">
			받은메세지</a>&nbsp;&nbsp;|&nbsp;&nbsp;
		...
		<c:if test="${param.fromMember != null}">
			<a class="navList" href="${pageContext.request.contextPath}/message/list.do?no=${member.no}">받은메세지</a>&nbsp;&nbsp;|&nbsp;&nbsp;
		...
		<div id="${msgList.no}" class="row" onclick="">
			...
			<a href="${pageContext.request.contextPath}/message/view.do?no=${msgList.no}">
			...
			<a href="${pageContext.request.contextPath}/message/insertForm.do?fromMember=${msgList.frommNick}">
			${msgList.frommNick}</a>
			</c:if>
			...
			<div id="check" class="cell mini"><a href="${pageContext.request.contextPath}/message/delete.do?no=${msgList.no}&memNo=${member.no}">
		...
		<script>
			function messageInsert(){
				location.href = "${pageContext.request.contextPath}/message/insertForm.do?no=${member.no}";
			};
			function msgDel(){
				location.href = "${pageContext.request.contextPath}/message/delete.do?no=${msgList.no}&memNo=${member.no}";
			};
			function testUri(){
