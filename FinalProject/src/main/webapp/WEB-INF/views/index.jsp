				...
				<div class="dc-content">
								...
								<div id="noticeTable" class="dc-tb-body">
									<c:if test="${!empty noticeList}">
										<c:forEach items="${noticeList}" var="item">
											<div class="dc-tb-row">
												<a
													href="${pageContext.request.contextPath}/community/notice/noticeView.do?bno=${item.no}">●
													<strong>[${item.boardType}] </strong><span>${item.title}</span>
												</a>
											</div>
										</c:forEach>
									</c:if>
					...
					<div class="dc-ad-box" style="height: 100px;">
						...
						<div class="ad-main-middle">
							<img id="ad-main-middle-img" src="" alt="" width="798px"
								height="100px" />
						</div>
					</div>
										...
										<c:if test="${!empty groupList}">
											<c:forEach items="${groupList}" var="item">
												<div class="main-img-div">
													<a
														href="/dc/sale/group/groupView.do?boardNo=${item.boardNo}">
														<span> <img src="${item.goodsPicture}" width="190" />
													</span>
														<div class="img-text">
															<strong>${item.title}</strong><br /> <span>${item.goodsCategory }</span>
														</div>
													</a>
												</div>
											</c:forEach>
								...
								<div id="freeTable" class="dc-tb-body">
									<c:if test="${!empty freeList}">
										<c:forEach items="${freeList}" var="item">
											<div class="dc-tb-row">
												<a
													href="${pageContext.request.contextPath}/community/free/freeView.do?bno=${item.no}">●
					...
					<div class="dc-ad-box" style="height: 100px;">
						...
						<div class="ad-main-bottom">
							<img id="ad-main-bottom-img" src="" alt="" width="798px"
								height="100px" />
						</div>
							...
							<div class="dc-tb">
								...
								<div class="dc-tb-body">
									<c:forEach begin="1" end="10">
										<div class="dc-tb-row">
											<a href="#">● <span><strong>[공지]</strong> 여러분 오늘
													미세먼지가 매우 심합니다. 아이들 외출 자제해주세요. 좋은하루 되세요 ^_____^</span></a>
										</div>
									</c:forEach>
								</div>
							</div>
