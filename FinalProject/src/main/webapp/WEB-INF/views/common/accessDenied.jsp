...
<body>
	...
	<h2>권한이 없습니다.</h2> --%>
		<div class="1006_center" align="center" style="margin: 0 auto; ">
		<div class="" style="width: 500px; margin-top: 200px;">
      		<form class="form-signin" method="post" action="#">
				...
				<p style="font-size: 50px; font-weight: bold;">1006 ERROR :(</p>
				<span style="font-size: 25px; font-weight: bold;">Sorry, accessDenied</span>
